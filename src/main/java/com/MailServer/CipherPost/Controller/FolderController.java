...
public class FolderController {
    ...
    public ResponseEntity<List<FolderMessage>> getPaginatedMessages(
        ...
        Page<FolderMessage> messagesPage = folderService.getPaginatedMessages(folder, page, size);
        System.out.println("Messages page content: " + messagesPage.getContent());

        return new ResponseEntity<>(messagesPage.getContent(), HttpStatus.OK);
    }
}
